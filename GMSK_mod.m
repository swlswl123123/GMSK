...
signal_trans_IF = signal_trans_BB .* exp(1i*f_IF*t);
...
% BandPass(round((f_IF-10e6)/fs_IF*oversamp_IF*num_bits_pulse):round((f_IF+10e6)/fs_IF*oversamp_IF*num_bits_pulse)) = 1;
